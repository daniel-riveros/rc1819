...
% Es cierto si ListaDivisores unifica con los
% divisores de X que van desde 1 hasta Y

divisores(X, 1, [1]) :- number(X). % Comprobamos si X es un número o no
...
% Es cierto si R unifica con los números primos que van desde X hasta Y.
